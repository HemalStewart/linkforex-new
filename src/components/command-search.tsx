...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    ...
    { title: "Transfers", url: "/transfers", group: "Operations", icon: ArrowRightLeft },
    { title: "Remitters", url: "/remitters", group: "Operations", icon: User },
    { title: "Receivers", url: "/receivers", group: "Operations", icon: User },
    { title: "KYC Reviews", url: "/kyc", group: "Operations", icon: Shield },
    { title: "Branches", url: "/branches", group: "Management", icon: Building2 },
    { title: "Branch Rates", url: "/branch-rates", group: "Management", icon: Coins },
    { title: "Users", url: "/users", group: "Management", icon: User },
    { title: "Mobile Profiles", url: "/mobile-profiles", group: "Mobile", icon: Smartphone },
    { title: "Mobile Control", url: "/mobile-users/control", group: "Mobile", icon: Smartphone },
    { title: "Countries", url: "/countries", group: "Basic Data", icon: Globe },
    { title: "Banks", url: "/banks", group: "Basic Data", icon: Building2 },
    { title: "Relationships", url: "/relationships", group: "Basic Data", icon: User },
    { title: "Purposes", url: "/purposes", group: "Basic Data", icon: ListChecks },
    { title: "Reports", url: "/reports", group: "System", icon: BarChart3 },
    { title: "Settings", url: "/settings", group: "System", icon: Settings },
    { title: "Support Inbox", url: "/support", group: "System", icon: MessageCircle },
    { title: "Rates", url: "/rates", group: "System", icon: Bell },
  ]
